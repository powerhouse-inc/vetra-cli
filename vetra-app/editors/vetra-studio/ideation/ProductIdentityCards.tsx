...
function IdentityCard({
  ...
  if (node) {
    return (
      <button
        ...
        className="flex h-28 flex-col justify-between rounded-xl border border-border bg-card p-4 text-left transition-colors hover:border-vetra-primary hover:shadow-sm"
      >
  ...
  return (
    <button
      ...
      onClick={() => void create()}
      disabled={creating}
      className="flex h-28 flex-col items-center justify-center rounded-xl border border-dashed border-border bg-accent p-4 transition-colors hover:border-vetra-primary disabled:opacity-50"
    >
