// Copied verbatim from vetra-cloud-package/shared/subdomain-generator.ts (via
// vetra.to/modules/cloud/subdomain.ts). Must produce identical output for the
// same document ID — the gitops namespace derives from the same fragment.
...
export function generateSubdomain(documentId: string): string {
  ...
  // fragment gitops appends for the namespace).
