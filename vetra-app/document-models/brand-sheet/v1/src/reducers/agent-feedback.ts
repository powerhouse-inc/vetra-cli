import type { BrandSheetAgentFeedbackOperations } from "document-models/brand-sheet/v1";
import {
...
export const brandSheetAgentFeedbackOperations: BrandSheetAgentFeedbackOperations =
  {
