import type { ProblemSheetAgentFeedbackOperations } from "document-models/problem-sheet/v1";
import {
...
export const problemSheetAgentFeedbackOperations: ProblemSheetAgentFeedbackOperations =
  {
