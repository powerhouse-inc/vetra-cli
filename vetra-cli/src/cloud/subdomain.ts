...
const ADJECTIVES = [
  ...
  "happy", "keen", "kind", "lush", "mild", "neat", "nice", "pure", "rare",
  "safe", "slim", "soft", "sure", "tall", "true", "vast", "warm", "wise",
  "blue", "gold", "jade", "ruby", "sage", "teal", "wild", "zesty", "amber",
  "brave", "clear", "deep", "fresh", "green", "ivory", "light", "noble",
  "prime", "rapid", "sharp", "swift", "vivid", "coral",
];

const ANIMALS = [
  "bear", "bird", "bull", "colt", "crab", "crow", "deer", "dove", "duck",
  "fawn", "fish", "frog", "goat", "hawk", "hare", "ibis", "kite", "lamb",
  "lark", "lion", "lynx", "mole", "moth", "newt", "orca", "puma", "quail",
  "robin", "seal", "slug", "swan", "toad", "vole", "wasp", "wolf", "wren",
  "yak", "ant", "bat", "bee", "cat", "cod", "cow", "dog", "eel", "elk",
  "emu", "fox", "gnu", "hen",
];
...
export function generateSubdomain(documentId: string): string {
  ...
  // Unique, collision-proof suffix: the first 8 hex chars of the id.
